...
import kotlinx.android.synthetic.main.building_style.view.*

class BuildingRecycler(var activity: Activity, var data: List<Building>) :
    RecyclerView.Adapter<BuildingRecycler.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view: View = LayoutInflater.from(activity).inflate(R.layout.building_style, parent, false)
